...
<?php if(!empty(Debug::$data)): ?>
  <li class="nav-item">
    <a class="nav-link active" id="debug-tab" data-toggle="tab" href="#debug" role="tab" aria-controls="debug" aria-selected="true">Depurar</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="this-tab" data-toggle="tab" href="#this" role="tab" aria-controls="this" aria-selected="false">Esta</a>
  </li>
  <?php else: ?>
  <li class="nav-item">
    <a class="nav-link" id="this-tab" data-toggle="tab" href="#this" role="tab" aria-controls="this" aria-selected="false">Esta</a>
