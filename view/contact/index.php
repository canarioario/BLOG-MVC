...
<div class="container mb-5">
    <!-- Loop to get all data for individual article -->
        <h1 class="text-center mt-5 mb-5">Siéntete libre de contactarnos</h1>

        <iframe src="https://www.google.com/maps/d/embed?mid=12FfWz9zPOX7aEUtREMVs2OyFzwjbSrlf" width="100%" height="500"></iframe>
        ...
        <div class="row mt-5">
            <div class="col">
                ...
                <div class="text-muted">
                    <p class="mb-0">Calle Jose fariñas</p>
                    <p class="mb-0">21006 Huelva</p>
                    <p class="mb-0">Huelva</p>
                </div>
            </div>

            <div class="col">
                <h5 class="card-title">Contacto info</h5>
                <div class="text-muted">
                    <p class="mb-0">contact@marcos.com</p>
                    <p class="mb-0">info@marcos.com </p>
                    <p class="mb-0">Telf: +34 615 212 345</p>
                </div>
            </div>
        </div>
</div>
