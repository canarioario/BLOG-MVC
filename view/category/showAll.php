...
<div class="container">
<h1 class="text-center mt-5">Categoria: <?= $categoryName ?></h1>
...
<form id="search_php" method="GET" action="<?= URL ?>category/showCategory/<?= $activeCategory ?>">
    <div class="input-group mb-3">
        <input type="text" value="<?=$search?>" class="form-control" name="search" placeholder="¿Que quieres buscar?" aria-describedby="button-addon2">
