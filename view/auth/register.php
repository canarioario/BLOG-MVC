    ...
    <div class="col-md-8 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <form action="<?php echo URL; ?>auth/doRegister" method="POST" name="myForm">
                ...
                <div class="form-group">
                    <label for="confirm_password">Confirma Contraseña: <sup>*</sup></label>
                ...
                <div class="row">
                    ...
                    <div class="col">
                    <a href="<?php echo URL; ?>auth/login" class="btn btn-light btn-block">¿Ya tienes una cuenta? Inicia sesión</a>
                    </div>
                </div>       
            </form>
        </div>
